...
/** \class MatBinFinders::GeneralBinFinderInR
...
template <class T>
class MatBinFinders::GeneralBinFinderInR : public BaseBinFinder<T>{
public:
...
/** \class MatBinFinders::GeneralBinFinderInZ
...
template <class T>
class MatBinFinders::GeneralBinFinderInZ : public BaseBinFinder<T> {
public:
