...
/** \class AlexeyBinFinders::GeneralBinFinderInR
...
template <class T>
class AlexeyBinFinders::GeneralBinFinderInR : public BaseBinFinder<T>{
public:
...
/** \class AlexeyBinFinders::GeneralBinFinderInZ
...
template <class T>
class AlexeyBinFinders::GeneralBinFinderInZ : public BaseBinFinder<T> {
public:
