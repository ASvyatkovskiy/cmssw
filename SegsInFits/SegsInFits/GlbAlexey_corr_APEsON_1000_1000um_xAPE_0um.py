...
process.muonAPEs = cms.ESSource("PoolDBESSource", process.CondDBSetup,
 connect = cms.string('sqlite_file:/afs/cern.ch/user/p/pakhotin/public/2014-06-20_ArtificialMuonGeometriesWithAPEs/muonGeometry_xSigma_1000um_xAPE_0um.db'),
...
process.TFileService = cms.Service('TFileService', fileName=cms.string('zp2mu_histos_ON_pT1000_1000um_xAPE_0um.root'))
