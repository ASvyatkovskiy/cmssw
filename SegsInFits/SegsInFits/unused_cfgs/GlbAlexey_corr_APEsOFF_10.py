...
'/store/group/phys_muon/giovanni/CMSSW_7_1_0_pre7/SingleMuPt10_UP15/default/SingleMuPt10_UP15_CMSSW_7_1_0_pre7_default_GEN-SIM-DIGI-RAW-HLTDEBUG.root'
 )
)
...
process.TFileService = cms.Service('TFileService', fileName=cms.string('zp2mu_histos_10OFF.root'))
