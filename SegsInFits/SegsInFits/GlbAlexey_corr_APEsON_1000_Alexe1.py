...
process.muonAlignment = cms.ESSource("PoolDBESSource",
                                    process.CondDBSetup,
                                    connect = cms.string("sqlite_file:/afs/cern.ch/user/a/asvyatko/APEStudy2014/CMSSW_7_1_0_pre9/src/SegsInFits/SegsInFits/scenario2014_Alexey1.db"),
                                    toGet = cms.VPSet(
...
process.TFileService = cms.Service('TFileService', fileName=cms.string('zp2mu_histos_1000ON_Alexe1.root'))
