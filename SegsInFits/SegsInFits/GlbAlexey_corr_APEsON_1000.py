...
process.muonAlignment = cms.ESSource("PoolDBESSource",
                                    ...
                                    #connect = cms.string("sqlite_file:/afs/cern.ch/user/a/asvyatko/APEStudy2014/CMSSW_7_1_0_pre9/src/SegsInFits/SegsInFits/test0823.db"),
                                    toGet = cms.VPSet(
...
#process.MessageLogger.categories   = ['Alignment','GeometryAligner']
...
#    GeometryAligner = cms.untracked.PSet(limit = cms.untracked.int32(-1)),
#)  
